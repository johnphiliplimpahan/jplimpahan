...
export default function About() {
  return (
    <section className="py-32 md:py-40 px-6 md:px-12 lg:px-24 bg-[#080808]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            <h2 className="font-display text-4xl md:text-5xl font-bold tracking-tight leading-tight mb-8">
          ...
          <div className="grid grid-cols-3 lg:grid-cols-1 gap-8 lg:gap-12">
            {STATS.map((stat, i) => (
              <motion.div
                key={stat.label}
              ...
              >
                <span className="font-display text-5xl md:text-6xl font-black text-white block leading-none mb-2">
                  {stat.value}
                </span>
